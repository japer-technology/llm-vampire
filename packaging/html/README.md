...
LM Studio Vampire is the product; these are supporting browser tools that talk
to LM Studio surfaces directly from the browser.

| File | Purpose |
| --- | --- |
| [`landing.html`](landing.html) | Marketing/landing page describing the gateway. |
| [`vampire-scanner.html`](vampire-scanner.html) | Browser scanner that probes LM Studio surfaces and identity headers. |
