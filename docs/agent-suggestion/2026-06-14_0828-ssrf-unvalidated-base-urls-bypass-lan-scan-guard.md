...
- **Notes:** Implemented shared http(s) target validation for discovery base URLs, node registration, and node URL patching; off-scope literal IP targets are rejected before probing.
